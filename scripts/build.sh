...
go build -ldflags "-X github.com/YuxSccc/coreth_opt/plugin/evm.GitCommit=$coreth_commit -X github.com/YuxSccc/coreth_opt/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
